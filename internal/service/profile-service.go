...
func (us *UserService) GetByLogin(ctx context.Context, login string) ([]byte, uuid.UUID, error) {
	...
	// if err != nil {
	// 	return nil, uuid.Nil, fmt.Errorf("UserService ->  Login -> RepositoryUser -> AddRefreshToken -> error: %w", err)
	// }
	return hash, id, nil
}
...
// 	if err != nil {
// 		return &TokenPair{}, fmt.Errorf("UserService-Refresh-GetPasswordByUsernsame: error: %w", err)
// 	}
// 	sum := sha256.Sum256([]byte(tokenPair.RefreshToken))
...
// 	err = us.uRep.AddRefreshToken(context.Background(), &user)
// 	if err != nil {
// 		return &TokenPair{}, fmt.Errorf("UserService-Refresh-AddRefreshToken: error: %w", err)
// 	}
...
// 	if err != nil {
// 		return TokenPair{}, fmt.Errorf("UserService-GenerateTokenPair-GenerateJWTToken: error: %w", err)
// 	}
